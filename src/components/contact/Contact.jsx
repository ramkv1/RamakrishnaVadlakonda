...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_lrkdihg', 'template_pc1yc4m', form.current, 'QVArMZv5XVK9Zgbli')
      .then((result) => {
                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">vadlakondaramakrishna961@gmail.com</span>
                            <a href="mailto:vadlakondaramakrishna961@gmail.com
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+91 9553358227</span>
                            <a href="https://api.whatsapp.com/send?phone=9553358227&text=Hello,Ramakrishna Vadlakonda could you provide more Information ?
                            " className="contact__button">Write me {" "}</a>
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </div>
